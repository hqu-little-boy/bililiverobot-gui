...
public:
    ...
    Q_INVOKABLE bool isEnabled() const { return m_isEnabled; }
    ...
    Q_INVOKABLE int speed() const { return m_speed; }
    Q_INVOKABLE void setSpeed(int speed);

    Q_INVOKABLE QString voice() const { return m_voice; }
    Q_INVOKABLE void setVoice(const QString &voice);

    Q_INVOKABLE QStringList availableVoices() const { return m_availableVoices; }
