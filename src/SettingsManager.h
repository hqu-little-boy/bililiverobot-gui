...
class SettingsManager : public QObject
{
    ...
    // // 分享感谢设置
    // Q_PROPERTY(
    //     bool shareThanksEnabled READ shareThanksEnabled WRITE setShareThanksEnabled NOTIFY shareThanksEnabledChanged)
    // Q_PROPERTY(
    //     QString shareThanksMessage READ shareThanksMessage WRITE setShareThanksMessage NOTIFY shareThanksMessageChanged)
    //
    // // 直播间设置
    ...
    // // 盲盒设置
    // Q_PROPERTY(
    //     bool blindBoxTipEnabled READ blindBoxTipEnabled WRITE setBlindBoxTipEnabled NOTIFY blindBoxTipEnabledChanged)
    // Q_PROPERTY(
    //     QString blindBoxTipMessage READ blindBoxTipMessage WRITE setBlindBoxTipMessage NOTIFY blindBoxTipMessageChanged)
    // Q_PROPERTY(
    //     int blindBoxRankTabsIndex READ blindBoxRankTabsIndex WRITE setBlindBoxRankTabsIndex NOTIFY
    //     blindBoxRankTabsIndexChanged)
...
public:
    ...
    // 礼物设置
    Q_INVOKABLE bool giftEnabled() const { return m_giftEnabled; }
    Q_INVOKABLE void setGiftEnabled(bool enabled) { m_giftEnabled = enabled; }
    Q_INVOKABLE QString giftMessage() const { return m_giftMessage; }
    Q_INVOKABLE void setGiftMessage(const QString& message) { m_giftMessage = message; }
    Q_INVOKABLE uint32_t giftThanksDelay() const { return m_giftThanksDelay; }
    Q_INVOKABLE void setGiftThanksDelay(uint32_t delay) { m_giftThanksDelay = delay; }
    // 关注答谢设置
    ...
    // 盲盒设置
    Q_INVOKABLE bool blindBoxTipEnabled() const { return m_blindBoxTipEnabled; }
    Q_INVOKABLE void setBlindBoxTipEnabled(bool enabled) { m_blindBoxTipEnabled = enabled; }
    Q_INVOKABLE QString blindBoxTipMessage() const { return m_blindBoxTipMessage; }
    Q_INVOKABLE void setBlindBoxTipMessage(const QString& message) { m_blindBoxTipMessage = message; }
    Q_INVOKABLE int blindBoxRankTabsIndex() const { return m_blindBoxRankTabsIndex; }
    Q_INVOKABLE void setBlindBoxRankTabsIndex(int index) { m_blindBoxRankTabsIndex = index; }
