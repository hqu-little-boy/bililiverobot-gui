...
public:
    ...
    Q_INVOKABLE bool isLoggedIn() const { return m_isLoggedIn; }
    Q_INVOKABLE bool isConnected() const { return m_isConnected; }
    Q_INVOKABLE QString qrCodeUrl() const { return m_qrCodeUrl; }
    Q_INVOKABLE QString loginStatus() const { return m_loginStatus; }
    Q_INVOKABLE QString currentRoomId() const { return m_currentRoomId; }
